...
function sous_menu() {
  ...
  <div class="activite_h"><h1 class="activite_h1" >Modifier les informations du compte</h1></div>
    ...
    <form method="POST" class="register-form" id="register-form" >
                            ...
                            <div >
                                ...
                                <input type="text" name="C_NOM"  value="<?php echo $row["C_NOM"] ;?>"  required style=" border: solid 1px #0ED5C9;" >
                            </div>
                            <div style=" position: relative; bottom: 75px; left: 500px;">
                                <label for="prenom">Prénom :</label>
                                <input type="text" name="C_PRENOM"  value="<?php echo $row["C_PRENOM"];  ?>" required style=" border: solid 1px #0ED5C9;" >
                            </div>
                        
                        
                            <div style="position: relative;bottom: 50px;">
                                <label for="DATE_NAISSANCE">Date de naissance :</label>
                                <input type="date" name="C_DATE_NAISSANCE" value="<?php echo $row["C_DATE_NAISSANCE"];  ?>" style=" border: solid 1px #0ED5C9;" required>
                            </div>
                           <div class="form-radio" style="margin-bottom: 2px; position: relative; bottom: 120px; left: 500px; ">
                            ...
                            <div style="position: relative; bottom: 100px; ">
                                ...
                                <input type="text" name="C_ADRESSE"  value="<?php echo $row["C_ADRESSE"];  ?>" required style=" border: solid 1px #0ED5C9;" >
                            </div>
                            <div style="position: relative;bottom: 178PX; left: 500px;">
                                <label for="ville">Ville :</label>
                                <input type="text" name="C_VILLE"  value="<?php echo $row["C_VILLE"];  ?>"  required style=" border: solid 1px #0ED5C9;" >
                            </div>
                        
    
                        <div style="position: relative;bottom: 135px;  " >
                            <label for="Telephone">Telephone :</label>
                            <input type="tel" maxlength="10" pattern="[0-9]{10}" title="0-(5,6,7)-12345678" minlenght="10"  value="<?php echo $row["C_TELEPHONE"];  ?>" name="C_TELEPHONE" required style=" border: solid 1px #0ED5C9;" >
                        </div>
                        <div style="position: relative;bottom: 212px; left: 500px; ">
                            <label for="email">Email :</label>
                            <input type="email" name="C_EMAIL"  value="<?php echo $row["C_EMAIL"];  ?>" required style=" border: solid 1px #0ED5C9;" >
                        </div>
                        <div style="position: relative;bottom: 180px;">
                            <label for="password1">Mot de passe :</label>
                            <input type="password" name="C_PASSWORD1" required style=" border: solid 1px #0ED5C9; background-color: white;color: black;" >
                        </div>
                        <div style="position: relative;bottom: 250px; left: 500px;" >
                            <label for="password2">Confirmer le mot de passe :</label>
                            <input type="password" name="C_PASSWORD2" required style=" border: solid 1px #0ED5C9; background-color: white; color: black" >
                        </div>
                        <div style="position: relative; bottom: 200px;left: 290px;" >
