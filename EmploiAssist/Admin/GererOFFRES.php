...
function sous_menu() {
  ...
  <body>
    ...
    <!-- Banner -->
      ...
      <div class="espace_admin">
          ...
          <div class="activite_h"><h1 class="activite_h1" >Les entreprises inscrits</h1></div>
           <div class="activite_message">
   
  <input type="button" name="" value="Affiche moins" class="tout_afficher_offre" onclick="affiche_entreprise_moins()">
  ...
  <div class="activite_h"><h1 class="activite_h1" > Les Recruteurs inscrits</h1></div>
  
  <div>
  	<div style="position: relative; left:70px;">
  	<img src="../images/ctm.png" style="margin-right: 30px; ">
  	<img src="../images/pic02.jpg" style="margin-right: 30px; width: 18%; ">
  	<img src="../images/pic01.jpg" style="margin-right: 30px;width: 18%; ">
  	<img src="../images/PizzaHut.png" style="margin-right: 30px;width: 18%; ">
  	</div>
  	<div style="position: relative; left: 70px; top: 70PX;">
  	<img src="../images/central.jpg" style="margin-right: 30px;width: 18%; ">

  	<img src="../images/2M.jpg" style="margin-right: 30px; width: 18%;">
  	<img src="../images/almountakhab.jpg" style="margin-right: 30px; width: 18%;">
  	<img src="../images/wafabank.jpg" style="margin-right: 30px; width: 18%;">
  </div>

  </div>
  
  <input type="button" name="" value="Tout afficher" class="tout_afficher_offre" onclick="affiche_entreprise()">
