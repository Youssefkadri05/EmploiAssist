...
function sous_menu() {
  ...
  <div class="activite_h"><h1 class="activite_h1" >les informations du candidat</h1></div>
     ...
     <form method="POST" class="register-form" id="register-form" >
                        ...
                        <table class="table_info">
                            ...
                            <tr class="tr_info"  >
                              ...
                              <td class="td_info_left"> Nom :</td> <td class="td_info_right"> <?php echo $row["C_NOM"] ;?> </td>
                            </tr >
                            <tr class="tr_info" style=" position: relative; bottom: 0px;">
                                <td class="td_info_left">Prenom :</td>
                                <td class="td_info_right"><?php echo $row["C_PRENOM"];  ?></td>
                            </tr >
                            <tr class="tr_info">
                                <td class="td_info_left">Date du naissance :</td>
                                <td class="td_info_right"><?php echo $row["C_DATE_NAISSANCES"];  ?></td>
                            </tr >
                                                     
                    
                        <tr class="tr_info">
                            <td class="td_info_left">Sexe :</td>
                            <td class="td_info_right"><?php echo $row["C_SEXE"];  ?></td>
                        </tr >
                        <tr class="tr_info">
                            <td class="td_info_left">Adresse :</td>
                            <td class="td_info_right"> <?php echo $row["C_ADRESSE"];  ?></td>
                        </tr >
                        <tr class="tr_info" >
                            <td class="td_info_left">Ville :</td>
                            <td class="td_info_right"><?php echo $row["C_VILLE"];  ?></td>
                        </tr >
                        <tr class="tr_info">
                            <td class="td_info_left">Téléphone :</td>
                            <td class="td_info_right"><?php echo $row["C_TELEPHONE"];  ?></td>
                        </tr >
                         <tr class="tr_info" >
                            <td class="td_info_left">Email :</td>
                            <td class="td_info_right"><?php echo $row["C_EMAIL"];  ?></td>
                        </tr >
                    ...
                    <div style="width: 35%;height: 500px; position: relative;  left: 50%; bottom: 450px;">
                      ...
                      <img src="../images/Profile.png" style="width: 80%;height: 50%; margin-top: 40px;">
