  ...
  <body>
    ...
    <tr class="colonne_simple"> 
           <td class="ceuille" data-title="Age"> 
            ...
            <td class="ceuille" data-title="Age">
                <a href="informationEntreprise.php"><img class="gener_image" title ="afficher toutes les information "src="../images/details1.png"> </a> 
               <a href="ModifierEntreprise.php"><img class="gener_image" title="Modifier" src="../images/modifier1.png"> </a>
