  ...
  <body>
    ...
    <tr class="colonne_bar">
      ...
      <td class="ceuille">
                              ...
                              <?php
                                  ...
                                  if ($result3_1->num_rows > 0) {
                                    while ($row  = $result3_1->fetch_assoc()) {
                                      ?>
    ...
    <tr class="colonne_simple"> 
           <td class="ceuille" data-title="Age"> 
                <?php echo $row["C_NOM"].' '.$row["C_PRENOM"]; ?></td> 

            <td class="ceuille" data-title="Age"> <?php echo $row["C_DATE_INSCRIPTION"]; ?> </td> 

            <td class="ceuille" data-title="Age"><?php echo $row["DIPLOME"] ;?> </td> 

            <td class="ceuille"  ><?php echo $row["C_EMAIL"]; ?></td>  

            <td class="ceuille" data-title="Age">
                <a href="informationcandidat.php"><img class="gener_image" title ="afficher toutes les information "src="../images/details1.png"> </a> 
               <a href="Modifiercandidat.php"><img class="gener_image" title="Modifier" src="../images/modifier1.png"> </a>
                <img class="gener_image" title="Supprimer" src="../images/supprimer.jpg"  onclick="confirm()" >
            </td>
          </tr>
  ...
  <div class="activite_h"><h1 class="activite_h1" > Candidats inscrits</h1></div>
   ...
   <table class="table1" id="table2">
    ...
    <tr class="colonne_simple"> 
                ...
                <td class="ceuille" data-title="Age"> <?php echo $row["C_NOM"].' '.$row["C_PRENOM"]; ?> </td>
